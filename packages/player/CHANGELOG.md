...
- Deterministic 403 recovery for native player: fetch fresh playback URL and send via `media.recover` instead of full restart when CDN token expires mid-stream
