...
- Sync to new API definitions (version: 1.10.135)
## [0.47.0] - 2026-09-16

### Changed

- Sync to new API definitions (version: 1.10.133)
...
- Republish the API definitions from version 1.10.128 after fixing the release toolchain.

## [0.45.0] - 2026-09-11

### Changed

- Sync to new API definitions (version: 1.10.128)
## [0.44.0] - 2026-08-20
...
- Sync to new API definitions (version: 1.10.100)

## [0.42.0] - 2026-08-14

### Changed

- Sync to new API definitions (version: 1.10.99)

## [0.41.0] - 2026-08-12

### Changed

- Sync to new API definitions (version: 1.10.97)
...
- Sync to new API definitions (version: 1.10.42)
